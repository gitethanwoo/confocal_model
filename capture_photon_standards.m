function [fluors, fluorStandard, channelVal, fluorsCombined] =  capture_photon_standards(fluors, fitdichroicSpectra, fitRange,scaledBright, detector)

%capture_photon_standards Uses laser and fluorophore information to capture our pure,
