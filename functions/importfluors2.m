...
f = readmatrix('assets/fluors/alexaFluors.csv', 'NumHeaderLines', 1); %import alexa fluors)
f(isnan(f)) = 0; %convert NAN to 0

a = readmatrix('assets/fluors/attoFluors.csv', 'NumHeaderLines', 1); %import ATTO fluors
a(isnan(a)) = 0; %convert NAN to 0

fb = readmatrix('assets/fluors/alexaBrightness.csv');
ab = readmatrix('assets/fluors/attoBrightness.csv');
