...
[fluors, fluorStandard, channelVal, fluorsCombined] = capturestandards(fluors, filters(1).fitSpectra, fitRange, scaledBright, detector);
...
FOMS = captureUnmix(fluorStandard, fluorsCombined, filters(1).fitSpectra, fitRange, detector);
